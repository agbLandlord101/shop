...
const ActivateCardPage: React.FC = () => {
  ...
  const isFormValid = cardNumber.length === 16 && expirationDate && cvv.length === 3;
  ...
  Green Dot Cards are issued by Green Dot Bank, Member FDIC, pursuant to a license from Visa U.S.A., Inc. Visa is a registered trademark of Visa International Service Association. Green Dot Bank also operates under the following registered trade names: <strong>GO2bank, GoBank,</strong> and <strong>Bonneville Bank.</strong> These registered trade names are used by, and refer to, a single FDIC-insured bank, Green Dot Bank. Deposits under any of these trade names are deposits with Green Dot Bank and are aggregated for deposit insurance coverage up to the allowable limits.
</p>
      </div>
    </div>
  );
